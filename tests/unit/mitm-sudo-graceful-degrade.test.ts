 ...
 *
 * Birouter's runtime Docker image (`Dockerfile`) runs as `USER node` (UID 1000)
 ...
 *
 * This mirrors upstream behavior (decolua/9router) extended to Birouter's TS
 * fork and Birouter's existing root-detection (`isRoot()`).
 */
