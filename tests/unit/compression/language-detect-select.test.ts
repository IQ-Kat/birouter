...
import { detectCompressionLanguage } from "@birouter/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@birouter/open-sse/services/compression/caveman.ts";
