...
import { normalizeClaudeHaikuConstraints } from "@birouter/open-sse/services/claudeHaikuConstraints.ts";
...
// Several Birouter paths can still emit these on Haiku targets:
