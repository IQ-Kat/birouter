...
process.env.DATA_DIR = mkdtempSync(join(tmpdir(), "birouter-embeddings-gemini-dim-"));
...
// so Birouter must forward `outputDimensionality` alongside `dimensions` for Gemini
