...
const TRANSLATIONS = {
  ar: {
    common: {
      error: "خطأ: {message}",
      serverOffline: "خادم Birouter غير متصل. ابدأ بالأمر: birouter serve",
      authRequired: "المصادقة مطلوبة. عيّن BIROUTER_API_KEY أو شغّل: birouter setup",
    ...
    program: {
      description: "Birouter — جهاز توجيه الذكاء الاصطناعي مع التبديل التلقائي",
      ...
      api_key: "مفتاح API لخادم Birouter",
      base_url: "عنوان URL الأساسي لخادم Birouter",
      context: "سياق/ملف تعريف الخادم المستخدم في هذا الأمر",
      lang: "تعيين لغة عرض CLI (يتجاوز BIROUTER_LANG)",
    },
  },
  az: {
    common: {
      error: "Xəta: {message}",
      serverOffline: "Birouter serveri oflayndır. Başladın: birouter serve",
      authRequired:
        "Autentifikasiya tələb olunur. BIROUTER_API_KEY təyin edin və ya işə salın: birouter setup",
    ...
    program: {
      description: "Birouter — Avtomatik Fallback ilə Ağıllı AI Marşrutlaşdırıcısı",
      ...
      api_key: "Birouter serveri üçün API açarı",
      base_url: "Birouter server baza URL-i",
      context: "Bu əmr üçün server konteksti/profili",
      lang: "CLI ekran dilini təyin edin (BIROUTER_LANG-ı keçir)",
    },
  },
  bg: {
    common: {
      error: "Грешка: {message}",
      serverOffline: "Сървърът Birouter е офлайн. Стартирайте с: birouter serve",
      authRequired:
        "Необходима е автентикация. Задайте BIROUTER_API_KEY или изпълнете: birouter setup",
    ...
    program: {
      description: "Birouter — Интелигентен AI рутер с автоматично превключване",
      ...
      api_key: "API ключ за сървъра Birouter",
      base_url: "Базов URL на сървъра Birouter",
      context: "Контекст/профил на сървъра за тази команда",
      lang: "Задай език на CLI (замества BIROUTER_LANG)",
    },
  },
  cs: {
    common: {
      error: "Chyba: {message}",
      serverOffline: "Server Birouter je offline. Spusťte: birouter serve",
      authRequired: "Vyžaduje se ověření. Nastavte BIROUTER_API_KEY nebo spusťte: birouter setup",
    ...
    program: {
      description: "Birouter — Chytrý AI router s automatickým přepínáním",
      ...
      api_key: "API klíč pro server Birouter",
      base_url: "Základní URL serveru Birouter",
      context: "Kontext/profil serveru pro tento příkaz",
      lang: "Nastavit jazyk CLI (přepisuje BIROUTER_LANG)",
    },
  },
  da: {
    common: {
      error: "Fejl: {message}",
      serverOffline: "Birouter-serveren er offline. Start med: birouter serve",
      authRequired: "Godkendelse kræves. Sæt BIROUTER_API_KEY eller kør: birouter setup",
    ...
    program: {
      description: "Birouter — Smart AI-router med automatisk fallback",
      ...
      api_key: "API-nøgle til Birouter-serveren",
      base_url: "Birouter-serverens basis-URL",
      context: "Server-kontekst/profil til denne kommando",
      lang: "Angiv CLI-visningssprog (tilsidesætter BIROUTER_LANG)",
    },
  },
  de: {
    common: {
      error: "Fehler: {message}",
      serverOffline: "Birouter-Server ist offline. Starten mit: birouter serve",
      authRequired:
        "Authentifizierung erforderlich. BIROUTER_API_KEY setzen oder ausführen: birouter setup",
    ...
    program: {
      description: "Birouter — Intelligenter AI-Router mit automatischem Fallback",
      ...
      api_key: "API-Schlüssel für den Birouter-Server",
      base_url: "Birouter-Server-Basis-URL",
      context: "Server-Kontext/Profil für diesen Befehl",
      lang: "CLI-Anzeigesprache festlegen (überschreibt BIROUTER_LANG)",
    },
  },
  es: {
    common: {
      error: "Error: {message}",
      serverOffline: "El servidor Birouter está offline. Inícielo con: birouter serve",
      authRequired: "Autenticación requerida. Configure BIROUTER_API_KEY o ejecute: birouter setup",
    ...
    program: {
      description: "Birouter — Router de IA inteligente con fallback automático",
      ...
      api_key: "Clave de API para el servidor Birouter",
      base_url: "URL base del servidor Birouter",
      context: "Contexto/perfil del servidor para este comando",
      lang: "Establecer idioma del CLI (reemplaza BIROUTER_LANG)",
    },
  },
  fa: {
    common: {
      error: "خطا: {message}",
      serverOffline: "سرور Birouter آفلاین است. با این دستور راه‌اندازی کنید: birouter serve",
      authRequired:
        "احراز هویت لازم است. BIROUTER_API_KEY را تنظیم کنید یا اجرا کنید: birouter setup",
    ...
    program: {
      description: "Birouter — روتر هوشمند هوش مصنوعی با fallback خودکار",
      ...
      api_key: "کلید API برای سرور Birouter",
      base_url: "URL پایه سرور Birouter",
      context: "زمینه/پروفایل سرور برای این دستور",
      lang: "تنظیم زبان نمایش CLI (BIROUTER_LANG را نادیده می‌گیرد)",
    },
  },
  fi: {
    common: {
      error: "Virhe: {message}",
      serverOffline: "Birouter-palvelin on offline. Käynnistä komennolla: birouter serve",
      authRequired: "Todennus vaaditaan. Aseta BIROUTER_API_KEY tai suorita: birouter setup",
    ...
    program: {
      description: "Birouter — Älykäs AI-reititin automaattisella fallbackilla",
      ...
      api_key: "API-avain Birouter-palvelimelle",
      base_url: "Birouter-palvelimen perus-URL",
      context: "Palvelimen konteksti/profiili tälle komennolle",
      lang: "Aseta CLI-näyttökieli (ohittaa BIROUTER_LANG)",
    },
  },
  fr: {
    common: {
      error: "Erreur : {message}",
      serverOffline: "Le serveur Birouter est hors ligne. Démarrez avec : birouter serve",
      authRequired:
        "Authentification requise. Définissez BIROUTER_API_KEY ou exécutez : birouter setup",
    ...
    program: {
      description: "Birouter — Routeur IA intelligent avec basculement automatique",
      ...
      api_key: "Clé API pour le serveur Birouter",
      base_url: "URL de base du serveur Birouter",
      context: "Contexte/profil du serveur pour cette commande",
      lang: "Définir la langue d'affichage du CLI (remplace BIROUTER_LANG)",
    },
  },
  hi: {
    common: {
      error: "त्रुटि: {message}",
      serverOffline: "Birouter सर्वर ऑफलाइन है। शुरू करें: birouter serve",
      authRequired: "प्रमाणीकरण आवश्यक है। BIROUTER_API_KEY सेट करें या चलाएं: birouter setup",
    ...
    program: {
      description: "Birouter — ऑटो फॉलबैक के साथ स्मार्ट AI राउटर",
      ...
      api_key: "Birouter सर्वर के लिए API कुंजी",
      base_url: "Birouter सर्वर का बेस URL",
      context: "इस कमांड के लिए सर्वर संदर्भ/प्रोफ़ाइल",
      lang: "CLI प्रदर्शन भाषा सेट करें (BIROUTER_LANG को ओवरराइड करता है)",
    },
  },
  hu: {
    common: {
      error: "Hiba: {message}",
      serverOffline: "Az Birouter szerver offline. Indítsa el: birouter serve",
      authRequired:
        "Hitelesítés szükséges. Állítsa be az BIROUTER_API_KEY-t vagy futtassa: birouter setup",
    ...
    program: {
      description: "Birouter — Intelligens AI útválasztó automatikus fallbackkel",
      ...
      api_key: "API kulcs az Birouter szerverhez",
      base_url: "Az Birouter szerver alap URL-je",
      context: "Szerverkontextus/profil ehhez a parancshoz",
      lang: "CLI megjelenítési nyelv beállítása (felülírja az BIROUTER_LANG-ot)",
    },
  },
  id: {
    common: {
      error: "Kesalahan: {message}",
      serverOffline: "Server Birouter sedang offline. Mulai dengan: birouter serve",
      authRequired: "Autentikasi diperlukan. Setel BIROUTER_API_KEY atau jalankan: birouter setup",
    ...
    program: {
      description: "Birouter — Router AI Cerdas dengan Fallback Otomatis",
      ...
      api_key: "Kunci API untuk server Birouter",
      base_url: "URL dasar server Birouter",
      context: "Konteks/profil server untuk perintah ini",
      lang: "Atur bahasa tampilan CLI (menggantikan BIROUTER_LANG)",
    },
  },
  it: {
    common: {
      error: "Errore: {message}",
      serverOffline: "Il server Birouter è offline. Avviarlo con: birouter serve",
      authRequired:
        "Autenticazione richiesta. Impostare BIROUTER_API_KEY o eseguire: birouter setup",
    ...
    program: {
      description: "Birouter — Router AI intelligente con fallback automatico",
      ...
      api_key: "Chiave API per il server Birouter",
      base_url: "URL base del server Birouter",
      context: "Contesto/profilo del server per questo comando",
      lang: "Imposta la lingua di visualizzazione della CLI (sovrascrive BIROUTER_LANG)",
    },
  },
  ja: {
    common: {
      error: "エラー: {message}",
      serverOffline: "Birouterサーバーはオフラインです。起動: birouter serve",
      authRequired: "認証が必要です。BIROUTER_API_KEYを設定するか実行してください: birouter setup",
    ...
    program: {
      description: "Birouter — 自動フォールバック付きスマートAIルーター",
      version: "バージョンを表示して終了",
      output: "出力形式 (table, json, jsonl, csv)",
      quiet: "重要でない出力を抑制",
      no_color: "カラー出力を無効化",
      timeout: "HTTPリクエストタイムアウト（ミリ秒）",
      api_key: "BirouterサーバーのAPIキー",
      base_url: "BirouterサーバーのベースURL",
      context: "このコマンドで使用するサーバーコンテキスト/プロファイル",
      lang: "CLI表示言語を設定（BIROUTER_LANGを上書き）",
    },
  },
  ko: {
    common: {
      error: "오류: {message}",
      serverOffline: "Birouter 서버가 오프라인입니다. 시작: birouter serve",
      authRequired: "인증이 필요합니다. BIROUTER_API_KEY를 설정하거나 실행하세요: birouter setup",
    ...
    program: {
      description: "Birouter — 자동 폴백 기능을 갖춘 스마트 AI 라우터",
      version: "버전 출력 후 종료",
      output: "출력 형식 (table, json, jsonl, csv)",
      quiet: "불필요한 출력 억제",
      no_color: "색상 출력 비활성화",
      timeout: "HTTP 요청 타임아웃(밀리초)",
      api_key: "Birouter 서버의 API 키",
      base_url: "Birouter 서버 기본 URL",
      context: "이 명령에 사용할 서버 컨텍스트/프로필",
      lang: "CLI 표시 언어 설정 (BIROUTER_LANG 재정의)",
    },
  },
  nl: {
    common: {
      error: "Fout: {message}",
      serverOffline: "Birouter-server is offline. Start met: birouter serve",
      authRequired: "Authenticatie vereist. Stel BIROUTER_API_KEY in of voer uit: birouter setup",
    ...
    program: {
      description: "Birouter — Slimme AI-router met automatische fallback",
      ...
      api_key: "API-sleutel voor de Birouter-server",
      base_url: "Basis-URL van de Birouter-server",
      context: "Servercontext/profiel voor dit commando",
      lang: "CLI-weergavetaal instellen (overschrijft BIROUTER_LANG)",
    },
  },
  no: {
    common: {
      error: "Feil: {message}",
      serverOffline: "Birouter-serveren er offline. Start med: birouter serve",
      authRequired: "Autentisering kreves. Angi BIROUTER_API_KEY eller kjør: birouter setup",
    ...
    program: {
      description: "Birouter — Smart AI-ruter med automatisk fallback",
      ...
      api_key: "API-nøkkel for Birouter-serveren",
      base_url: "Birouter-serverens basis-URL",
      context: "Serverkontekst/profil for denne kommandoen",
      lang: "Angi CLI-visningsspråk (overstyrer BIROUTER_LANG)",
    },
  },
  pl: {
    common: {
      error: "Błąd: {message}",
      serverOffline: "Serwer Birouter jest offline. Uruchom: birouter serve",
      authRequired: "Wymagane uwierzytelnienie. Ustaw BIROUTER_API_KEY lub uruchom: birouter setup",
    ...
    program: {
      description: "Birouter — Inteligentny router AI z automatycznym fallbackiem",
      ...
      api_key: "Klucz API dla serwera Birouter",
      base_url: "Bazowy URL serwera Birouter",
      context: "Kontekst/profil serwera dla tego polecenia",
      lang: "Ustaw język wyświetlania CLI (nadpisuje BIROUTER_LANG)",
    },
  },
  pt: {
    common: {
      error: "Erro: {message}",
      serverOffline: "O servidor Birouter está offline. Inicie com: birouter serve",
      authRequired: "Autenticação necessária. Defina BIROUTER_API_KEY ou execute: birouter setup",
    ...
    program: {
      description: "Birouter — Router de IA inteligente com fallback automático",
      ...
      api_key: "Chave de API para o servidor Birouter",
      base_url: "URL base do servidor Birouter",
      context: "Contexto/perfil do servidor para este comando",
      lang: "Definir idioma de apresentação do CLI (substitui BIROUTER_LANG)",
    },
  },
  ro: {
    common: {
      error: "Eroare: {message}",
      serverOffline: "Serverul Birouter este offline. Porniți cu: birouter serve",
      authRequired: "Autentificare necesară. Setați BIROUTER_API_KEY sau rulați: birouter setup",
    ...
    program: {
      description: "Birouter — Router AI inteligent cu fallback automat",
      ...
      api_key: "Cheie API pentru serverul Birouter",
      base_url: "URL de bază al serverului Birouter",
      context: "Contextul/profilul serverului pentru această comandă",
      lang: "Setează limba de afișare CLI (suprascrie BIROUTER_LANG)",
    },
  },
  ru: {
    common: {
      error: "Ошибка: {message}",
      serverOffline: "Сервер Birouter отключён. Запустите: birouter serve",
      authRequired:
        "Требуется аутентификация. Установите BIROUTER_API_KEY или выполните: birouter setup",
    ...
    program: {
      description: "Birouter — Умный AI-маршрутизатор с автоматическим переключением",
      ...
      api_key: "API-ключ для сервера Birouter",
      base_url: "Базовый URL сервера Birouter",
      context: "Контекст/профиль сервера для этой команды",
      lang: "Установить язык отображения CLI (переопределяет BIROUTER_LANG)",
    },
  },
  sk: {
    common: {
      error: "Chyba: {message}",
      serverOffline: "Server Birouter je offline. Spustite: birouter serve",
      authRequired:
        "Vyžaduje sa overenie. Nastavte BIROUTER_API_KEY alebo spustite: birouter setup",
    ...
    program: {
      description: "Birouter — Inteligentný AI router s automatickým prepínaním",
      ...
      api_key: "API kľúč pre server Birouter",
      base_url: "Základná URL servera Birouter",
      context: "Kontext/profil servera pre tento príkaz",
      lang: "Nastaviť jazyk zobrazenia CLI (prepíše BIROUTER_LANG)",
    },
  },
  sv: {
    common: {
      error: "Fel: {message}",
      serverOffline: "Birouter-servern är offline. Starta med: birouter serve",
      authRequired: "Autentisering krävs. Ange BIROUTER_API_KEY eller kör: birouter setup",
    ...
    program: {
      ...
      api_key: "API-nyckel för Birouter-servern",
      base_url: "Birouter-serverns bas-URL",
      context: "Serverkontext/profil för det här kommandot",
      lang: "Ange CLI-visningsspråk (åsidosätter BIROUTER_LANG)",
    },
  },
  th: {
    common: {
      error: "ข้อผิดพลาด: {message}",
      serverOffline: "เซิร์ฟเวอร์ Birouter ออฟไลน์ เริ่มด้วย: birouter serve",
      authRequired: "ต้องการการยืนยันตัวตน ตั้งค่า BIROUTER_API_KEY หรือรัน: birouter setup",
    ...
    program: {
      description: "Birouter — AI Router อัจฉริยะพร้อม Auto Fallback",
      ...
      api_key: "API Key สำหรับ Birouter server",
      base_url: "Base URL ของ Birouter server",
      context: "บริบท/โปรไฟล์ของเซิร์ฟเวอร์สำหรับคำสั่งนี้",
      lang: "ตั้งค่าภาษาแสดงผล CLI (แทนที่ BIROUTER_LANG)",
    },
  },
  tr: {
    common: {
      error: "Hata: {message}",
      serverOffline: "Birouter sunucusu çevrimdışı. Başlatın: birouter serve",
      authRequired:
        "Kimlik doğrulama gerekli. BIROUTER_API_KEY ayarlayın veya çalıştırın: birouter setup",
    ...
    program: {
      description: "Birouter — Otomatik Fallback ile Akıllı AI Yönlendirici",
      ...
      api_key: "Birouter sunucusu için API anahtarı",
      base_url: "Birouter sunucusu temel URL'si",
      context: "Bu komut için sunucu bağlamı/profili",
      lang: "CLI görüntüleme dilini ayarla (BIROUTER_LANG'ı geçersiz kılar)",
    },
  },
  "uk-UA": {
    common: {
      error: "Помилка: {message}",
      serverOffline: "Сервер Birouter відключено. Запустіть: birouter serve",
      authRequired:
        "Потрібна автентифікація. Встановіть BIROUTER_API_KEY або виконайте: birouter setup",
    ...
    program: {
      description: "Birouter — Розумний AI-маршрутизатор з автоматичним перемиканням",
      ...
      api_key: "API-ключ для сервера Birouter",
      base_url: "Базовий URL сервера Birouter",
      context: "Контекст/профіль сервера для цієї команди",
      lang: "Встановити мову відображення CLI (замінює BIROUTER_LANG)",
    },
  },
  vi: {
    common: {
      error: "Lỗi: {message}",
      serverOffline: "Máy chủ Birouter đang offline. Khởi động với: birouter serve",
      authRequired: "Cần xác thực. Đặt BIROUTER_API_KEY hoặc chạy: birouter setup",
    ...
    program: {
      description: "Birouter — Bộ định tuyến AI thông minh với tự động chuyển đổi dự phòng",
      ...
      api_key: "Khóa API cho máy chủ Birouter",
      base_url: "URL cơ sở của máy chủ Birouter",
      context: "Bối cảnh/hồ sơ máy chủ cho lệnh này",
      lang: "Đặt ngôn ngữ hiển thị CLI (ghi đè BIROUTER_LANG)",
    },
  },
  "zh-CN": {
    common: {
      error: "错误：{message}",
      serverOffline: "Birouter 服务器已离线。请启动：birouter serve",
      authRequired: "需要认证。请设置 BIROUTER_API_KEY 或运行：birouter setup",
    ...
    program: {
      description: "Birouter — 具有自动故障转移的智能 AI 路由器",
      version: "打印版本并退出",
      output: "输出格式（table, json, jsonl, csv）",
      quiet: "禁止非必要输出",
      no_color: "禁用彩色输出",
      timeout: "HTTP 请求超时（毫秒）",
      api_key: "Birouter 服务器的 API 密钥",
      base_url: "Birouter 服务器的基础 URL",
      context: "此命令使用的服务器上下文/配置文件",
      lang: "设置 CLI 显示语言（覆盖 BIROUTER_LANG）",
    },
  },
};
