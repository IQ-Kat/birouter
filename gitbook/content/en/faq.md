...
Common questions about Birouter.

---

## What is Birouter?

**Birouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**Birouter uses a 3-tier pricing strategy:**
...
**Yes, Birouter itself is 100% free and open source.**
...
**Yes! This is Birouter's core feature.**
...
**Birouter tracks quota in real-time for all providers:**
...
## Can I self-host Birouter?

**Yes! Birouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.birouter`)
...
**Yes, Birouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.birouter` (or custom `DATA_DIR`)
- No data sent to Birouter servers
...
**What Birouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What Birouter does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/IQ-Kat/birouter/blob/main/CHANGELOG.md)
- Backup `~/.birouter` before major updates
...
See [CONTRIBUTING.md](https://github.com/IQ-Kat/birouter/blob/main/CONTRIBUTING.md) for details.
