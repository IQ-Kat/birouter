...
Integrate Birouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Birouter API key from [dashboard](https://birouter.com/dashboard)
- Birouter running (local or cloud)
...
### 2. Add Birouter Model Configuration
...
3. Choose your preferred Birouter model
...
- Check network latency to Birouter
