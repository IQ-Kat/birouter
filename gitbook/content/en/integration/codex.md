...
Integrate Birouter with OpenAI Codex CLI to route your OpenAI API requests through Birouter's intelligent routing system.
...
Birouter provides the following Codex models:
...
1. Verify your API key is correct in Birouter dashboard
...
2. Check that the OpenAI provider connection is active in Birouter dashboard
