...
Deploy Birouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.birouter` | Database and data storage path |
...
Create `/etc/nginx/sites-available/birouter`:
