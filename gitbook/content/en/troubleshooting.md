...
Common issues and solutions when using Birouter.
...
1. **Auto-refresh (default):**
   Birouter automatically refreshes tokens. Wait 30 seconds and retry.
...
**Problem:** "ECONNREFUSED" or "Cannot connect to localhost:2004".

**Causes:**
- Birouter not running
- Port 2004 blocked
...
1. **Check if Birouter is running:**
   ```bash
   # Check process
