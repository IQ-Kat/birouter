...
Những câu hỏi phổ biến về Birouter.

---

## Birouter là gì?

**Birouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**Birouter dùng chiến lược pricing 3 tầng:**
...
## Birouter có miễn phí không?

**Có, Birouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của Birouter.**
...
**Birouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host Birouter không?

**Có! Birouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.birouter`)
...
**Có, Birouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.birouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server Birouter
...
## Làm thế nào để cập nhật Birouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/IQ-Kat/birouter/blob/main/CHANGELOG.md)
- Backup `~/.birouter` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/IQ-Kat/birouter/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [birouter.com/docs](https://birouter.com/docs)
