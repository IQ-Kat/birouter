...
Tích hợp Birouter với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của Birouter.
...
Birouter cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong Birouter dashboard
...
1. Xác minh tên model khớp với cấu hình Birouter
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong Birouter dashboard
...
Đảm bảo bạn đã cấu hình API key trong Birouter cloud dashboard.
