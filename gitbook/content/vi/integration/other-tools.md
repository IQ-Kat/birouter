...
Birouter tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

Birouter cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến Birouter bằng các cài đặt sau:

**Birouter cục bộ:**
```
Base URL: http://localhost:2004/v1
API Key: your-api-key-from-dashboard
Model: any Birouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Vấn đề:** Không kết nối được đến Birouter
```bash
# Check if Birouter is running
...
**Giải pháp:**
- Xác minh Birouter đang chạy
- Kiểm tra port 2004 không bị chặn
...
- Kiểm tra model có sẵn: `curl http://localhost:2004/v1/models`
...
- Kiểm tra kết nối network đến Birouter
