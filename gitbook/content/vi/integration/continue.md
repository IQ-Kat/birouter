...
Tích hợp Birouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- Birouter API key từ [dashboard](https://birouter.com/dashboard)
- Birouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model Birouter
...
3. Chọn model Birouter ưa thích
...
- Kiểm tra Birouter đang chạy: `curl http://localhost:2004/health`
...
- Kiểm tra độ trễ network đến Birouter
