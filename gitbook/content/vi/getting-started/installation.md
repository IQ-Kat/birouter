...
Hướng dẫn cài đặt chi tiết cho Birouter với mẹo troubleshooting.
...
Cài Birouter toàn cục để dùng ở bất kỳ đâu:
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `birouter`
- ✅ Auto-update với `npm update -g birouter`
...
**Điều gì xảy ra:**
1. Server khởi động tại `http://localhost:2004`
2. Dashboard tự động mở trong browser
3. Data directory được tạo tại `~/.birouter`
...
**Vấn đề:** Birouter dùng quá nhiều RAM
