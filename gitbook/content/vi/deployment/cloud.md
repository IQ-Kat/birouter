...
Triển khai Birouter trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.birouter` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/birouter`:
...
# If NOT using reverse proxy, allow Birouter ports
