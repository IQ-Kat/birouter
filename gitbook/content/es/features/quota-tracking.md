...
Birouter proporciona un seguimiento de cuota integral para todos los proveedores:
...
```bash
GET http://localhost:2004/api/quota
...
```bash
GET http://localhost:2004/api/usage?period=today
Authorization: Bearer your-api-key
...
4. Reinicia Birouter si el problema persiste
