...
Ejecuta Birouter en tu máquina local para desarrollo y uso personal.

---

## 📦 Instalación

Instala Birouter globalmente vía npm:
...
Inicia Birouter con un solo comando:
...
El puerto de API (2004) y el puerto del dashboard (3000) están configurados en la aplicación. Para cambiarlos, necesitarás modificar el código fuente o usar variables de entorno si se soportan.

---

## 🛑 Detener el servidor

Presiona `Ctrl+C` en la terminal donde Birouter se está ejecutando.

```bash
# En la terminal ejecutando birouter
^C  # Presiona Ctrl+C
```
...
Si el puerto 2004 o 3000 ya está en uso:
