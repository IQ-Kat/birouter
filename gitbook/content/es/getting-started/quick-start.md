...
Pon en marcha Birouter en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
🎉 **El dashboard se abre automáticamente** en `http://localhost:2004`
...
Apunta tu herramienta de codificación a Birouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de birouter]
