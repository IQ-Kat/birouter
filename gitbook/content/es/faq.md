...
Preguntas comunes sobre Birouter.

---

## ¿Qué es Birouter?

**Birouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**Birouter usa una estrategia de precios de 3 niveles:**
...
**Sí, Birouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de Birouter.**
...
**Birouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Birouter funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de Birouter:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://birouter.com/v1
...
## ¿Puedo auto-hospedar Birouter?

**¡Sí! Birouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.birouter`)
...
**Sí, Birouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.birouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de Birouter
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/IQ-Kat/birouter/blob/main/CHANGELOG.md)
- Respalda `~/.birouter` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/IQ-Kat/birouter/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/IQ-Kat/birouter/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/birouter.git
   cd birouter
...
Consulta [CONTRIBUTING.md](https://github.com/IQ-Kat/birouter/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [birouter.com/docs](https://birouter.com/docs)
