...
Integra Birouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de Birouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- Birouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de Birouter:
...
**Para Birouter en la nube:**
```
https://birouter.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de Birouter
...
3. La key debe comenzar con `sk-birouter-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de Birouter
...
4. Cline usará Birouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando Birouter
...
3. Obtén explicaciones potenciadas por IA a través de Birouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará Birouter para entender el contexto y hacer cambios
...
1. Verifica que Birouter esté corriendo: `curl http://localhost:2004/health`
2. Verifica que la URL base sea correcta e incluya `/v1`
3. Asegúrate de que ningún firewall esté bloqueando el puerto 2004
...
2. Verifica que tu instancia de Birouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de Birouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de Birouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://birouter.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de Birouter
...
## Integración con características de Birouter

### Enrutamiento de modelos

Birouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, Birouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de Birouter:
