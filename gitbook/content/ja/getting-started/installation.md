...
トラブルシューティングのヒント付きのBirouter詳細インストールガイド。
...
どこからでも使用できるようにBirouterをグローバルインストール:
...
**何が起こるか:**
1. サーバーが `http://localhost:2004` で起動
2. ダッシュボードが自動的にブラウザで開く
3. `~/.birouter` にデータディレクトリが作成される
4. APIキーが自動生成される
