...
BirouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをBirouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはBirouterモデルにマッピングされる以下のモデルエイリアスをサポート:
