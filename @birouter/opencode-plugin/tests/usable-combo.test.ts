 ...
 * `providerId` field — Birouter's `normalizeComboRecord` folds the provider
...
import { isUsableCombo, type BirouterRawCombo } from "../src/index.js";
...
function combo(models: BirouterRawCombo["models"]): BirouterRawCombo {
