...
// #2939: honor BIROUTER_MEMORY_MB (default 512), the same knob
// `birouter serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.BIROUTER_MEMORY_MB);
