...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-birouter-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-birouter-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-birouter-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-birouter-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-birouter-auth-scopes";
 ...
 * token matches this process's BIROUTER_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-birouter-peer-ip";
 ...
 * proxy hop (e.g. Birouter behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-birouter-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-birouter-peer-locality";
