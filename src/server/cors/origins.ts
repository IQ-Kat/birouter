 ...
 *
 * Source of truth for which browser origins may call Birouter over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-birouter-connection, x-internal-test, accept";
