...
import { checkTokenLimits } from "@birouter/open-sse/services/tokenLimitCounter.ts";
import {
  errorResponse,
  buildErrorBody,
...
const PLAYGROUND_KEY_ID_HEADER = "x-birouter-playground-key-id";
 ...
 * `x-birouter-playground-key-id` and we resolve the secret server-side.
 *
