...
interface BiSkillCardProps {
  skill: BiSkill;
  selected: boolean;
  onClick: () => void;
}

export function BiSkillCard({ skill, selected, onClick }: BiSkillCardProps): JSX.Element {
