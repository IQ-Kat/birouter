...
import { BiSkillCard } from "./BiSkillCard";
import { SkillInspectorPane } from "./SkillInspectorPane";
import type { BiSkill } from "./BiSkillCard";

interface BiSkillsListProps {
  skills: BiSkill[];
  skillsTotal: number;
  skillsPage: number;
