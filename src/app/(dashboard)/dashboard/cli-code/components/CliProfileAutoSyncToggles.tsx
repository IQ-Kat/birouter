...
const CODEX_KEY = "BIROUTER_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "BIROUTER_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the BIROUTER_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
