...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@birouter/open-sse/services/rateLimitManager"),
      import("@birouter/open-sse/services/accountFallback"),
      import("@birouter/open-sse/services/requestDedup.ts"),
      import("@birouter/open-sse/services/quotaMonitor.ts"),
      import("@birouter/open-sse/services/sessionManager.ts"),
