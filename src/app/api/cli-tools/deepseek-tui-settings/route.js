...
// Build TOML config for Birouter (openai provider mode)
const buildBirouterConfig = (baseUrl, apiKey, model) => {
...
// Detect Birouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildBirouterConfig(baseUrl, apiKey || "sk_birouter", model);
