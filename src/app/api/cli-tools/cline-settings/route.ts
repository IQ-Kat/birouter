...
// Check if Birouter is configured as OpenAI-compatible provider
const hasBirouterConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasBirouter: hasBirouterConfig(globalState),
...
// POST - Configure Cline to use Birouter as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_birouter";
...
// DELETE - Remove Birouter OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "Birouter settings removed from Cline",
    });
  } catch (error) {
