...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@birouter/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@birouter/open-sse/services/sessionManager.ts");
