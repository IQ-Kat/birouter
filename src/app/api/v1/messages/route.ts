...
} from "@birouter/open-sse/utils/earlyStreamKeepalive";
import { resolveKeepaliveThreshold } from "@birouter/open-sse/utils/keepaliveThreshold";
...
async function postHandler(request: any, context: any, preParsedBody: any = null) {
  ...
  // big context can exceed the client's stream/first-token watchdog. Birouter holds
