 ...
 *
 * Serves the Birouter A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the Birouter Agent Card that describes this gateway's
  ...
  const agentCard = {
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 Birouter agent skills (22 API + 20 CLI) " +
