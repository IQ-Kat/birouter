...
} from "@birouter/open-sse/config/providerHeaderProfiles.ts";
import { applyAntigravityClientProfileHeaders } from "@birouter/open-sse/services/antigravityClientProfile.ts";
import { getAntigravityHeaders } from "@birouter/open-sse/services/antigravityHeaders.ts";
import {
  getAntigravityFetchAvailableModelsUrls,
  ANTIGRAVITY_BASE_URLS,
} from "@birouter/open-sse/config/antigravityUpstream.ts";
import {
  getAntigravityRemainingCredits,
  updateAntigravityRemainingCredits,
} from "@birouter/open-sse/executors/antigravity.ts";
import { getCreditsMode } from "@birouter/open-sse/services/antigravityCredits.ts";
import {
  generateAntigravityRequestId,
  getAntigravitySessionId,
} from "@birouter/open-sse/services/antigravityIdentity.ts";
 ...
 * Real Claude OAuth quota windows are fetched in @birouter/open-sse/services/usage.ts.
 */
