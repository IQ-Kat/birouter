...
} from "@birouter/open-sse/services/antigravityHeaders.ts";
import {
...
import { resolvePublicCred } from "@birouter/open-sse/utils/publicCreds.ts";
...
// (http://127.0.0.1:<port>/?user_id=...&access_token=...). Birouter decrypts
