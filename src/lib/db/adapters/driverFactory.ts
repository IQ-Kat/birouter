...
declare global {
  var __birouterSqlJsAdapters: Map<string, SqliteAdapter> | undefined;
}

function getSqlJsCache(): Map<string, SqliteAdapter> {
  if (!globalThis.__birouterSqlJsAdapters) {
    globalThis.__birouterSqlJsAdapters = new Map();
  }
  return globalThis.__birouterSqlJsAdapters;
}
