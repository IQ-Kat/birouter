 ...
 * The PRIMARY key is now derived with a static salt ("birouter-field-encryption-v1").
 ...
 * a different derived key than the static salt `"birouter-field-encryption-v1"`. When the
