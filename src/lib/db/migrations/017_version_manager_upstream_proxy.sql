...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'birouter'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with Birouter
...
-- Determines whether each provider uses Birouter's native executor,
