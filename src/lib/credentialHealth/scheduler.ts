...
function getSchedulerState() {
  if (!globalThis.__birouterCredentialHC) {
    globalThis.__birouterCredentialHC = {
      initialized: false,
      sweepTimer: null,
  ...
  return globalThis.__birouterCredentialHC;
}
...
function isCredentialHealthCheckDisabled(): boolean {
  ...
  const val = process.env.BIROUTER_DISABLE_CREDENTIAL_HEALTH_CHECK;
