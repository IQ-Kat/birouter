/**
 * Global Type Declarations for Birouter
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    BIROUTER_PUBLIC_BASE_URL?: string;
    BIROUTER_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    BIROUTER_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    BIROUTER_BASE_URL?: string;
    BIROUTER_DISABLE_BACKGROUND_SERVICES?: string;
    BIROUTER_PORT?: string;
