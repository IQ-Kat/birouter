 ...
 *
 * When Birouter translates a Claude-native streamed response to OpenAI Chat
 ...
 * in explicitly with the request header `x-birouter-thinking-marker: off`,
...
export const THINKING_MARKER_HEADER = "x-birouter-thinking-marker";
...
/**
 * Interpret the explicit `x-birouter-thinking-marker` request header.
 ...
 * this request. An explicit `x-birouter-thinking-marker` header wins; absent
