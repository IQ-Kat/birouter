...
} from "@/domain/birouterResponseMeta";
 ...
 *
 * Birouter forwards upstream response headers verbatim. If we re-emit those
...
export function buildStreamingResponseHeaders(
  ...
  attachBirouterMetaHeaders(responseHeaders, meta);
