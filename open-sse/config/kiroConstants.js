 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what birouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a birouter
...
/**
 * Detect whether a model id refers to a birouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a birouter synthetic thinking variant
...
/**
 * Resolve a birouter model id to the real upstream Kiro model id, plus flags
