...
export const siliconflowProvider: RegistryEntry = buildOpenAiCompatibleRegistryEntry({
  ...
  models: [
    ...
    { id: "Qwen/Qwen3-Bi-30B-A3B-Instruct", name: "Qwen3 Bi 30B Instruct" },
    { id: "Qwen/Qwen3-Bi-30B-A3B-Thinking", name: "Qwen3 Bi 30B Thinking" },
    { id: "Qwen/Qwen3-Bi-30B-A3B-Captioner", name: "Qwen3 Bi 30B Captioner" },
