...
// local `droid` CLI. Birouter already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through Birouter.
//
...
// back to stored CLI credentials only when omitted. Birouter does NOT read
