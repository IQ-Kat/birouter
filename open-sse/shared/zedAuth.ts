 ...
 *
 *   1. The client (Birouter) generates an ephemeral RSA keypair.
 ...
 *   5. Birouter decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + Birouter conventions. `fetch` is intentionally the
