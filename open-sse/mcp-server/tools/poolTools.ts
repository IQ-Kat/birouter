/**
 * Birouter MCP Session Pool Tools — Manage and monitor anonymous web session pools.
 *
 * Tools:
 *   1. birouter_pool_status   — Get pool stats for one or all providers
 *   2. birouter_pool_sessions — List per-session details for a provider's pool
 *   3. birouter_pool_reset    — Shut down and recreate a pool
 *   4. birouter_pool_warm     — Warm up a pool to a target session count
 *   5. birouter_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  birouter_pool_status: {
    name: "birouter_pool_status",
    description:
  ...
  birouter_pool_sessions: {
    name: "birouter_pool_sessions",
    description:
  ...
  birouter_pool_health: {
    name: "birouter_pool_health",
    description:
  ...
  birouter_browser_pool_status: {
    name: "birouter_browser_pool_status",
    description:
