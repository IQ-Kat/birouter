 ...
 * API. They are birouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic birouter variant set for a single upstream Kiro model.
 *
 ...
 * into birouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
