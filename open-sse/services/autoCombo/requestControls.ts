 ...
 *
 *   X-Birouter-Mode:   fast | balanced | quality | <raw mode-pack name>  (#6024/#6025)
 *   X-Birouter-Budget: <max USD per request>                             (#6023)
 *
...
/**
 * Resolve the `X-Birouter-Mode` header value into a mode-pack override.
 *
...
/**
 * Parse the `X-Birouter-Budget` header into a hard per-request cost ceiling (USD).
