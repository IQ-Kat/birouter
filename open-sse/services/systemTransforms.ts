 ...
 *
 * Reference: Birouter issue #2260 + comment 4459544580 (Open WebUI bypass).
 */
 ...
 * verified against opencode→Birouter→Anthropic with claude-opus-4-7 OAuth.
 */
...
export const DEFAULT_SYSTEM_TRANSFORMS_CONFIG: SystemTransformsConfig = {
  providers: {
    [PROVIDER_CLAUDE]: {
      ...
      // usage` when opencode (or any non-claude-cli client) hits Birouter's
 ...
 *
 * `providerId` matches Birouter's provider key (`claude`,
...
const GLOBAL_KEY = "__birouter_systemTransforms_config__";
