---
title: "Birouter Codebase Documentation"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Birouter Codebase Documentation

> **Version:** v3.8.0
> **Last updated:** 2026-06-28
> **Audience:** Engineers contributing to Birouter or building integrations on top of it.
>
...
├── open-sse/             Streaming engine workspace (@birouter/open-sse)
├── electron/             Desktop wrapper (Electron 41 main + preload)
├── bin/                  CLI entry points (birouter, reset-password)
...
| `responses.ts`, `birouterResponseMeta.ts` | Response shape helpers                            |
...
Separate npm workspace published as `@birouter/open-sse`. Owns request
...
```
bin/
├── birouter.mjs           Main CLI entry (Node ESM)
...
- `birouter` → `bin/birouter.mjs`
- `birouter-reset-password` → `bin/reset-password.mjs`
