---
title: "Birouter — Uninstall Guide"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Birouter — Uninstall Guide
...
This guide covers how to cleanly remove Birouter from your system.

---

## Quick Uninstall (v3.6.2+)

Birouter provides two built-in scripts for clean removal:
...
This removes the Birouter application but **preserves** your database, configurations, API keys, and provider settings in `~/.birouter/`. Use this if you plan to reinstall later and want to keep your setup.
...
- Backup files
- Log files
- All files in the `~/.birouter/` directory
...
- Open `Settings → Apps → Birouter → Uninstall`
- Or run the NSIS uninstaller from the install directory

**macOS:**

- Drag `Birouter.app` from `/Applications` to Trash
- Remove data: `rm -rf ~/Library/Application Support/birouter`

**Linux:**

- Remove the AppImage file
- Remove data: `rm -rf ~/.birouter`
...
Birouter stores data in the following locations by default:
