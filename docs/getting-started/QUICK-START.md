# Quick Start: Get Birouter Running in 3 Minutes

> **TL;DR**: Install → Connect a free provider → Point your IDE to Birouter. Done.

---

## Step 1: Install Birouter
...
You can use Birouter **without paying anything** by connecting a free provider.
...
## Step 4: Point Your IDE to Birouter
...
That's it! Your IDE now uses Birouter with automatic provider selection.
...
`auto` tells Birouter to automatically pick the best provider for each request. It considers speed, cost, quality, and availability. See the [Auto-Combo Guide](./AUTO-COMBO-GUIDE.md) for details.

### "How much does it cost?"

Birouter itself is **free and open-source**. You only pay for the providers you use. Many providers have free tiers — see the [Free Tiers Guide](./FREE-TIERS-GUIDE.md).
...
Birouter automatically skips failed providers and tries the next one. You don't need to do anything. See the [Auto-Combo Guide](./AUTO-COMBO-GUIDE.md) for details.
...
- **[GitHub Issues](https://github.com/IQ-Kat/birouter/issues)** — Report bugs
