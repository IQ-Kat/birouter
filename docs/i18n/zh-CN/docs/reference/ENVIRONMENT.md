...
| 变量                                        | 默认值                         | 源文件                                                                   | 说明                                                                                                                                    |
| ------------------------------------------- | ------------------------------ | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| `PORT`                                      | `2004`                         | `src/lib/runtime/ports.ts`                                               | Dashboard UI 和 API 端点共用的主端口（单端口模式）。                                                                                    |
...
| 变量                                      | 默认值                                           | 源文件                                      | 说明                                                                                                                                                                                                                                                              |
| ----------------------------------------- | ------------------------------------------------ | ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `BASE_URL`                                | `http://localhost:2004`                          | `src/lib/cloudSync.ts`                      | 内部同步任务调用 `/api/sync/cloud` 的服务器端 URL。即使应用被公共代理，也保持为 loopback/容器 URL。                                                                                                                                                               |
...
| `NEXT_PUBLIC_BASE_URL`                    | `http://localhost:2004`                          | OAuth、Dashboard、同步                      | 面向公共的 URL，用于 OAuth redirect_uri、Dashboard 链接、生成的公共 URL 以及同源浏览器变更检查。**在反向代理背后时，必须匹配你的公共 URL。**                                                                                                                      |
...
| `ELECTRON_SMOKE_URL`                   | `http://127.0.0.1:2004/login` | `scripts/dev/smoke-electron-packaged.mjs` | Electron 烟雾测试工具期望打包应用提供服务的 URL。                                                                                                        |
...
| 变量               | 默认值                  | 源文件                                    | 说明                                                                                                 |
| ------------------ | ----------------------- | ----------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `OMNIROUTE_URL`    | `http://localhost:2004` | `scripts/ad-hoc/regen-opencode-config.ts` | 查询 `/v1/models` 的 OmniRoute 实例基础 URL。                                                        |
