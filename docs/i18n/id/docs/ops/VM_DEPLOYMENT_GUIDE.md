# Birouter — Panduan Deployment di VM dengan Cloudflare (Bahasa Indonesia)
...
Panduan lengkap untuk menginstal dan mengkonfigurasi Birouter pada sebuah VM (VPS) dengan domain yang dikelola melalui Cloudflare.
...
Jaga agar timeout stream reverse-proxy tetap selaras dengan variabel lingkungan timeout Birouter Anda. Jika Anda menaikkan
...
Lihat dokumentasi lengkap di [birouterCloud/README.md](../birouterCloud/README.md).
