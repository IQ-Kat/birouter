...
**Birouter** — proxy/router AI terpadu. Satu endpoint, 160+ penyedia LLM, auto-fallback.
...
Birouter memiliki tiga mekanisme kegagalan sementara yang terkait tetapi berbeda. Jaga agar ruang lingkup mereka terpisah saat melakukan debugging perilaku pengalihan. Lihat diagram
...
- **Impor**: eksternal → internal (`@/`, `@birouter/open-sse`) → relatif
...
- **Direktori data**: variabel lingkungan `DATA_DIR`, default ke `~/.birouter/`
