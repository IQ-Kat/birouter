...
**Birouter** — ఏకీకృత AI ప్రాక్సీ/రౌటర్. ఒక ఎండ్‌పాయింట్, 160+ LLM ప్రొవైడర్లు, ఆటో-ఫాల్బ్యాక్.
...
- **ఇంపోర్ట్స్**: బాహ్య → అంతర్గత (`@/`, `@birouter/open-sse`) → సంబంధిత
