# 🚀 Birouter — The Free AI Gateway (Português (Portugal))
...
> Substitua `seu-servidor.com` pelo domínio ou IP do seu servidor (inclua a porta se necessário, ex: `http://45.33.32.156:2004/callback`).
