# CLI Tools Setup Guide — Birouter (Português (Portugal))
...
to use **Birouter** as the unified backend, giving you centralized key management,
...
1. Open the Birouter dashboard → **API Manager** (`/dashboard/api-manager`)
...
> **Note:** Cursor routes requests through its cloud. For Birouter integration,
> enable **Cloud Endpoint** in Birouter Settings and use your public domain URL.

Via GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: your Birouter key
...
| Error                     | Cause                   | Fix                                        |
| ------------------------- | ----------------------- | ------------------------------------------ |
| `Connection refused`      | Birouter not running    | `pm2 start birouter`                       |
