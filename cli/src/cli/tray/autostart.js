 ...
 *   2. `process.argv[1]` if it's our cli.js — true when birouter is currently
 ...
 * SIGTERM to the running process. When the running birouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/birouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/birouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `birouter.cmd` lookup that depended on the npm prefix path.
